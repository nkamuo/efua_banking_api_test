...
@RestController
@RequestMapping("/api/accounts/{account}")
public class AccountTransferController {

    private final TransferRepository transferRepository;

    public AccountTransferController(TransferRepository transferRepository) {
...
//    public ResponseEntity<Page<Transfer>> getAllAccountTransfers(
